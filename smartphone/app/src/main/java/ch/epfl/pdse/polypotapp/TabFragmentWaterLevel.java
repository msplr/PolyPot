...
public class TabFragmentWaterLevel extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        final GraphView graph = (GraphView) getView().findViewById(R.id.graph_water_level);
        ...
        mListener = new CommunicationManager.DataReadyListener() {
            public void onDataReady(JSONArray data) {
                try {
                    LineGraphSeries<DataPoint> series = GraphHelper.extractSeries(data, "water_level");
