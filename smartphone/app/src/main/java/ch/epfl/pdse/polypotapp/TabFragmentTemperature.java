...
public class TabFragmentTemperature extends Fragment {
    ...
    public static TabFragmentTemperature newInstance(String server, String uuid) {
        TabFragmentTemperature f = new TabFragmentTemperature();
    ...
    private void updateDescription() {
        mDescription.setText(mActivity.getPlant().temperatureDescription);
    }
}
